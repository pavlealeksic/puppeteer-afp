...
exports.AdvancedProtections = void 0;
class AdvancedProtections {
    static getAdvancedCanvasProtection() {
        return `
    ...
    static getAdvancedWebGLProtection() {
        return `
    ...
    static getPerformanceAPIProtection() {
        return `
    ...
    static getFontFingerprintingProtection() {
        return `
    ...
    static getStorageFingerprintingProtection() {
        return `
    ...
    static getBehavioralProtection() {
        return `
    ...
    static getAllAdvancedProtections() {
        return `
...
exports.AdvancedProtections = AdvancedProtections;
//# sourceMappingURL=advanced-protections.js.map