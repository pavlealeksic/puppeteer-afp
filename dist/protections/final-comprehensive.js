...
exports.FinalComprehensiveProtection = void 0;
class FinalComprehensiveProtection {
    // Advanced DOM Fingerprinting Protection
    static getAdvancedDOMProtection() {
        return `
      // Advanced DOM Fingerprinting Protection
    ...
    static getGPUFingerprintingProtection() {
        return `
      // GPU Advanced Fingerprinting Protection
    ...
    static getInternationalizationProtection() {
        return `
      // Internationalization Fingerprinting Protection
    ...
    static getExtensionDetectionPrevention() {
        return `
      // Extension and Plugin Detection Prevention
      if (typeof document !== 'undefined') {
    ...
    static getAdvancedRandomizationEngine() {
        return `
      // Advanced Randomization Engine
    ...
    static getAllFinalComprehensiveProtections() {
        return `
...
exports.FinalComprehensiveProtection = FinalComprehensiveProtection;
//# sourceMappingURL=final-comprehensive.js.map