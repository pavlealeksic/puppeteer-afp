...
exports.BehavioralProtection = void 0;
class BehavioralProtection {
    static getMouseMovementNormalization() {
        return `
    ...
    static getKeyboardTimingNormalization() {
        return `
    ...
    static getScrollBehaviorNormalization() {
        return `
    ...
    static getClickPatternNormalization() {
        return `
    ...
    static getFocusPatternNormalization() {
        return `
    ...
    static getAllBehavioralProtections() {
        return `
...
exports.BehavioralProtection = BehavioralProtection;
//# sourceMappingURL=behavioral-protection.js.map