...
exports.StealthValidator = void 0;
...
class StealthValidator {
    ...
    async validateWebDriverDetection(page) {
        return await page.evaluate(() => {
            ...
            results.push({
                ...
                severity: 'critical',
                details: { hasProperty: 'webdriver' in navigator, value: navigator.webdriver },
            ...
            results.push({
                ...
                passed: !!window.chrome?.runtime,
                severity: 'high',
                details: { hasChromeRuntime: !!window.chrome?.runtime },
    ...
    async validateCanvasProtection(page) {
        return await page.evaluate(() => {
            const results = [];
            try {
    ...
    async validateWebGLProtection(page) {
        return await page.evaluate(() => {
            const results = [];
            try {
                const canvas = document.createElement('canvas');
    ...
    async validateAudioProtection(page) {
    ...
    async validateNavigatorProperties(page) {
        return await page.evaluate(() => {
            const results = [];
    ...
    async validateTimingConsistency(page) {
        return await page.evaluate(() => {
            const results = [];
    ...
    async validatePermissionHandling(page) {
        return await page.evaluate(async () => {
            const results = [];
    ...
    async validateErrorPatterns(page) {
        return await page.evaluate(() => {
            const results = [];
    ...
    async validateBehavioralConsistency(page) {
        return await page.evaluate(() => {
            const results = [];
    ...
    async validateAdvancedDetection(page) {
        return await page.evaluate(() => {
            const results = [];
    ...
    async attemptHealIssue(page, issue) {
...
exports.StealthValidator = StealthValidator;
//# sourceMappingURL=stealth-validator.js.map