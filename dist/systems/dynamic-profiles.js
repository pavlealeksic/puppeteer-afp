...
exports.DynamicProfileSystem = void 0;
const logger_1 = require("../logger");
class DynamicProfileSystem {
    ...
    selectProfileForSite(url, detectionRisk = 'medium') {
    ...
    findSiteSpecificProfile(hostname) {
    ...
    isProfileSuitableForRisk(profile, risk) {
        switch (risk) {
            case 'low':
    ...
    calculateProfileScore(profile, hostname) {
    ...
    updateProfileUsage(profileId, hostname) {
    ...
    recordDetection(profileId, hostname, detected) {
        const profile = this.profiles.get(profileId);
        if (!profile)
            return;
    ...
    createCustomProfile(name, baseProfileId, customizations) {
    ...
    getRecommendation(url, previousDetections = 0) {
        const hostname = new URL(url).hostname;
    ...
    assessSiteRisk(hostname, previousDetections) {
    ...
    generateReasoning(profile, risk, hostname) {
...
exports.DynamicProfileSystem = DynamicProfileSystem;
//# sourceMappingURL=dynamic-profiles.js.map