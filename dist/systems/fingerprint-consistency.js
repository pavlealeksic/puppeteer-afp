...
exports.FingerprintConsistencyManager = void 0;
const logger_1 = require("../logger");
class FingerprintConsistencyManager {
    constructor(options, enableLogging = false) {
    ...
    generateConsistentFingerprint(options) {
    ...
    correlateMemoryWithCores(cores) {
    ...
    generateCorrelatedScreenResolution(screenConfig) {
    ...
    generateCanvasFingerprint(cores, memory) {
    ...
    generateConsistentWebGL(cores, memory) {
    ...
    generateConsistentFonts(platform) {
    ...
    generateConsistentPlatform(options) {
    ...
    generateConsistentPerformance(cores, memory) {
...
exports.FingerprintConsistencyManager = FingerprintConsistencyManager;
//# sourceMappingURL=fingerprint-consistency.js.map