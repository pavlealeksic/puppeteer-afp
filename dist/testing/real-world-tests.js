...
exports.RealWorldTester = void 0;
...
class RealWorldTester {
    ...
    async testAudioFingerprinting() {
        ...
        try {
                ...
                return new Promise((resolve) => {
                    scriptProcessor.onaudioprocess = function (event) {
                        ...
                        const results = {
                            ...
                            sampleVariation: samples.slice(0, 100).reduce((acc, sample, i) => acc + Math.abs(sample - (samples[i - 1] || 0)), 0),
            ...
            await page.close();
            const audioTestsObj = audioTests;
...
exports.RealWorldTester = RealWorldTester;
//# sourceMappingURL=real-world-tests.js.map