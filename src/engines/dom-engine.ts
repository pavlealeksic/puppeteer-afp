...
export class DOMEngineEmulator {
  ...
  private initializeEventTimings(): void {
    const baseTimings = {
      'node-creation': 0.01,
      'node-removal': 0.005,
  ...
  private getDocumentScript(): string {
    return `
  ...
  private getElementScript(): string {
    return `
  ...
  private getMutationObserverScript(): string {
    return `
  ...
  private getTraversalScript(): string {
    return `
  ...
  private getAttributeScript(): string {
    return `
  ...
  private getTextContentScript(): string {
    return `
  ...
  private getDOMManipulationScript(): string {
    return `
  ...
  private getCustomElementsScript(): string {
    return `
  ...
  private getShadowDOMScript(): string {
    return `
  ...
  private getSelectionScript(): string {
    return `
...
export const domEngineConfigs: Record<string, DOMEngineConfig> = {
  chrome: {
    engine: 'blink',
