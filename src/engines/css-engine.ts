...
export class CSSEngineEmulator {
  private config: CSSEngineConfig;
  private styleCache: Map<string, CSSStyleDeclaration> = new Map();
  private computedStyleTimings: Map<string, number> = new Map();
  private layoutTimings: Map<string, number> = new Map();
  ...
  private initializeStyleTimings(): void {
    const baseTimings = {
  ...
  private getComputedStyleScript(): string {
    return `
  ...
  private getStyleSheetScript(): string {
    return `
  ...
  private getCSSRuleScript(): string {
    return `
  ...
  private getLayoutScript(): string {
    return `
  ...
  private getFontLoadingScript(): string {
    return `
  ...
  private getMediaQueryScript(): string {
    return `
  ...
  private getCustomPropertiesScript(): string {
    return `
  ...
  private getSelectorAPIScript(): string {
    return `
      // CSS Selector API
  ...
  private getPaintingAPIScript(): string {
    return `
  ...
  private getTransformFilterScript(): string {
    return `
  ...
  private getViewportScript(): string {
    return `
...
export const cssEngineConfigs: Record<string, CSSEngineConfig> = {
  chrome: {
    engine: 'blink',
